...
func New() *CommandEngine {
	eng := &CommandEngine{Commands: make(map[string]Command)}
...
func (e *CommandEngine) Invoke(ctx context.Context, param []string) {
	...
	if !ok {
		fmt.Errorf("error:"+NO_COMMAND, param[0])
		return
	}
	if cmd.Command != param[0] {
		fmt.Errorf("error:"+INCONFORMITY, param[0], cmd.Command)
		return
	}
...
// TidyParam 整理参数列表，返回带前导符(-，--)和不带前导符的参数与值
// 例如：-arg1 1 arg2 --arg3=3 -arg4=4 arg7 7 --arg5=5 arg6=6
// 返回：map[string]string{"arg1":"1","arg2":"","arg3":"3","arg4":"4","arg5":"5","arg6":"6","arg7":"7"}
